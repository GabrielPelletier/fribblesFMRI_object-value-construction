    ...
    for task_ind = 1:length(task_names)
        ...
        for seed_ind = 1 : length(seeds)
            ...
            for run_ind=runs
                ...
                fprintf(fid,'%s\n',['feat /export2/DATA/FRIB_FMRI/fmri_sample/derivatives/scripts/' modelID '_scripts/fsfs/lvl1/design_sub-' SUBNUM '_task-' TASKNAME '_ppi_seed-' SEEDNAME '_run-' RUNNUM '.fsf']);
