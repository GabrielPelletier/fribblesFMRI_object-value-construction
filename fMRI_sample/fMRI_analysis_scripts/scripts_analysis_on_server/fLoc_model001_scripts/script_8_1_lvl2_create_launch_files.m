...
launchFileName = ['/export2/DATA/FRIB_FMRI/fmri_sample/derivatives/scripts/fLoc_' modelID '_scripts/launch_files/lvl2_launch.txt'];
...
for sub_ind = 1:length(participants)
    ...
    for task_ind = 1:length(task_names)
        TASKNAME=task_names{task_ind};
            ...
            fprintf(fid,'%s\n',['feat /export2/DATA/FRIB_FMRI/fmri_sample/derivatives/scripts/fLoc_' modelID '_scripts/fsfs/lvl2/design_sub-' SUBNUM '_task-' TASKNAME '.fsf']);
    end%task
end%sub
