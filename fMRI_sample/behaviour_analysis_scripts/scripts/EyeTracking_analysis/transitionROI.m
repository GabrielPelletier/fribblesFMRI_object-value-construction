...
for t = conjTrials'
    % If no Fixations detectd in this trial put NaN as transition number and send Warning
    if isempty(eyeData.TrialFix{1,t})
        ...
        trans_conj(end, 2) = nan; % Number of transitions in this trial
        trans_conj(end, 3) = 0;  % Total number of fixations in this trial
        trans_conj(end, 4) = ratingData{t, 5}; % Value of Stimulus in this trial
        continue
    end
...
%        warning('Trial %d has 0 fixations, this might be indicativ of bad EyeTracking data', t);
        ...
        trans_summ(end, 2) = nan; % Number of transitions in this trial
        trans_summ(end, 3) = 0;  % Total number of fixations in this trial
        trans_summ(end, 4) = ratingData{t, 5}; % Value of Stimulus in this trial
        continue
    end
