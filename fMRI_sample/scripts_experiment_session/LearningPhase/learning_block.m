...
fprintf(fid1,'sub_num\ttrial_num\tstimulus\tfeedback\treal_value\treaction_time\trating\r\n');

%% Scale parameters, Question and Anchors
unicodeShekel = 8362;
if strcmp(condition,'Conjunction')
    anchorTxt = {double([unicodeShekel,uint16('20')]), double([unicodeShekel,uint16('100')])};
    %anchorTxt = {'$20', '$100'};
    anchorValues = [20 100];    
elseif strcmp(condition,'SingleAttribute')
    anchorTxt = {double([unicodeShekel,uint16('5')]), double([unicodeShekel,uint16('55')])};
    %anchorTxt = {'$5', '$55'};
    anchorValues = [5 55];
end
...
for i = 1:length(countdown)
    ...
    if strcmp(lang,'Hebrew')
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v1)))]), 'center',dest1(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest1);       
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v2)))]), 'center', dest2(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest2);
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v3)))]), 'center', dest3(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest3);
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v4)))]), 'center', dest4(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest4);
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v5)))]), 'center', dest5(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest5);
        DrawFormattedText(window, double([unicodeShekel,uint16(num2str(mean(v6)))]), 'center', dest6(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest6);
    elseif strcmp(lang,'English')
        DrawFormattedText(window, double([uint16(num2str(mean(v1))), unicodeShekel]), 'center',dest1(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest1);
        DrawFormattedText(window, double([uint16(num2str(mean(v2))), unicodeShekel]), 'center', dest2(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest2);
        DrawFormattedText(window, double([uint16(num2str(mean(v3))), unicodeShekel]), 'center', dest3(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest3);
        DrawFormattedText(window, double([uint16(num2str(mean(v4))), unicodeShekel]), 'center', dest4(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest4);
        DrawFormattedText(window, double([uint16(num2str(mean(v5))), unicodeShekel]), 'center', dest5(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest5);
        DrawFormattedText(window, double([uint16(num2str(mean(v6))), unicodeShekel]), 'center', dest6(2) + 0.08 * StimYsize, black,[],[],[],[],[],dest6);
    end
...
for tt = 1 : length(trialMatrix)
    ...
    fprintf(fid1, '%s\t%d\t%s\t%d\t%d\t%d\t%d\r\n', subjectNumber, tt, trialStimName, Outcome, stimAveValue, ratingTime,ratingValue);
