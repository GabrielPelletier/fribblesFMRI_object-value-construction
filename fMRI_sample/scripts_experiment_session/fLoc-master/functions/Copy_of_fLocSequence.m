classdef fLocSequence
    ...
    properties (Constant)
        stim_conds = {'Faces' 'Objects' 'Places' 'Scrambled'};
    ...
    properties (Constant, Hidden)
        ...
        stim_set3 = {'adult' 'instrument' 'house' 'scrambled'};
        stim_set4 = {'child' 'car' 'corridor' 'scrambled'};
        stim_per_set = 144;
    ...
    methods
        ...
        function run_sets = get.run_sets(seq)
            switch seq.stim_set
                ...
                case 3
                    ...
                    disp(run_sets);
                case 4
                    run_sets = [seq.stim_set3; seq.stim_set4];
                    cat_iters = ceil(seq.num_runs / 2);
                    run_sets = repmat(run_sets, cat_iters, 1);
                    run_sets = run_sets(1:seq.num_runs, :);
                otherwise
        ...
        function seq = make_runs(seq)
            ...
            block_conds = [zeros(1, seq.num_runs); block_conds]; % Baseline Cond at start of each run  %%%% GP Jan 2018
            block_dur = seq.stim_per_block * seq.stim_duty_cycle;
