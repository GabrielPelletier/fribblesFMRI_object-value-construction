function [position, RT, answer, t0] = slideScale_demo_mri(screenPointer, question, rect, endPoints, anchorValues, stimulusValue, stimAveValue, varargin)
...
%% Feedback
    ...
    % The slider
    sliderColorFeedback = scaleColor;
    Screen('DrawLine', screenPointer, sliderColorFeedback, x, rect(4)*scalaPosition - lineLength, x, rect(4)*scalaPosition  + lineLength, width);
    ...
    Screen('Flip', screenPointer);
    WaitSecs(2);
    Screen('FillRect',screenPointer, grey);
    Screen('Flip', screenPointer);
    WaitSecs(2);
