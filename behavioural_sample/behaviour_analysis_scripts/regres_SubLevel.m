...
%% 
% Where is the data?
%dataPath = '/Users/ExpRoom1/Desktop/GabrielP_Fribbles/analysisScripts_4mar/Data';
...
if bidsMainRawRatings_linReg
    hdat = figure('Name','Data'); % For data plots
end
if residualsPlot
    hres = figure('Name','Residuals'); % For residual plots
end
if bidsMainLinReg_CI
    hci = figure('Name','Regression and 95% Confidence Intervals');
end
...
%% Plot Data and model fit
    ...
    title(['sub-',num2str(subjectNumber),'- Raw ratings and linear regression fit']);
...
regres_SubLevel_models(subjectNumber).Conjunction = mdl1;
regres_SubLevel_models(subjectNumber).Summation = mdl2;
