...
function [learningProbe_Acc_Rt_group] = probeAnalysis_meanAccuracy (dataPath, subs, plotData, plot_probe_group_data)
...
learningProbe_Acc_Rt_group = table(SubjectID, conjMeanAcc_group, summMeanAcc_group, conjStdAcc_group, summStdAcc_group, ...
     conjMeanRt_group, summMeanRt_group, conjStdRt_group, summStdRt_group);
...
%% ACCURACY
    ...
    scatter(repmat(1,1,size(learningProbe_Acc_group.conjMeanAcc_group,1)), learningProbe_Acc_group.conjMeanAcc_group(:), 70, 'MarkerEdgeColor', C_color, 'MarkerFaceColor', C_color, 'MarkerFaceAlpha', 0.01, 'LineWidth', 1.5);
    scatter(repmat(2,1,size(learningProbe_Acc_group.summMeanAcc_group,1)),learningProbe_Acc_group.summMeanAcc_group(:), 70,'MarkerEdgeColor', E_color, 'MarkerFaceColor', E_color, 'MarkerFaceAlpha', 0.01, 'LineWidth', 1.5);
    hold off
    ...
    % Group averages
    a2 = subplot(2,2,2);
    bar(1, mean(learningProbe_Acc_group.conjMeanAcc_group(:)), 0.8, 'FaceColor', 'w', 'EdgeColor', C_color, 'LineWidth', 3); hold on
    bar(2, mean(learningProbe_Acc_group.summMeanAcc_group(:)), 0.8, 'FaceColor', 'w', 'EdgeColor', E_color, 'LineWidth', 3); hold on
   ...
   %                'Name', 'LEARNING PROBE - AVERAGE RT');
    ...
    scatter(repmat(1,1,size(learningProbe_Rt_group.conjMeanRt_group,1)), learningProbe_Rt_group.conjMeanRt_group(:), 70, 'MarkerEdgeColor', C_color, 'MarkerFaceColor', C_color, 'MarkerFaceAlpha', 0.01, 'LineWidth', 1.5);
    scatter(repmat(2,1,size(learningProbe_Rt_group.summMeanRt_group,1)),learningProbe_Rt_group.summMeanRt_group(:), 70,'MarkerEdgeColor', E_color, 'MarkerFaceColor', E_color, 'MarkerFaceAlpha', 0.01, 'LineWidth', 1.5);
    hold off
    %title ('All participants');
    xlim ([0.2 2.8]);
    xlabel('Configural     Elemental'); % x-axis label
    ...
    % Group averages
    a4 = subplot(2,2,4);
    bar(1, mean(learningProbe_Rt_group.conjMeanRt_group(:)), 0.8, 'FaceColor', 'w', 'EdgeColor', C_color, 'LineWidth', 3); hold on
    bar(2, mean(learningProbe_Rt_group.summMeanRt_group(:)), 0.8, 'FaceColor', 'w', 'EdgeColor', E_color, 'LineWidth', 3); hold on
    ...
    print(gcf1, '-dtiff', '../figures/learningProbe_accuracy_rt_behaviorSample.tiff', '-r600');
