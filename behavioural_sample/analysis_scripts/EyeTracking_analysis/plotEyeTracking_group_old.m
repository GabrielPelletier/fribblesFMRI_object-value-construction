...
% Single Subjects
    ...
    scatter(repmat(1,1,size(groupEyeData,1)), groupEyeData.groupTrans_conj, 70, 'MarkerEdgeColor', C_color, 'MarkerFaceColor', C_color, 'MarkerFaceAlpha', 0.5);
    scatter(repmat(2,1,size(groupEyeData,1)), groupEyeData.groupTrans_summ, 70,'MarkerEdgeColor', E_color, 'MarkerFaceColor', E_color, 'MarkerFaceAlpha', 0.5);
    hold off
...
% Group averages
    a4 = subplot(3,2,4);
    bar(1, mean(groupEyeData.groupTrans_conj), 0.8, 'FaceColor', C_color, 'EdgeColor', C_color); hold on
    bar(2, mean(groupEyeData.groupTrans_summ), 0.8, 'FaceColor', E_color, 'EdgeColor', E_color); hold on
...
% Single Subjects
    ...
    scatter(repmat(1,1,size(groupEyeData,1)), groupEyeData.groupNumFix_conj, 70, 'MarkerEdgeColor', C_color, 'MarkerFaceColor', C_color, 'MarkerFaceAlpha', 0.5);
    scatter(repmat(2,1,size(groupEyeData,1)), groupEyeData.groupNumFix_summ, 70,'MarkerEdgeColor', E_color, 'MarkerFaceColor', E_color, 'MarkerFaceAlpha', 0.5);
    hold off
    title ('All participants');
    xlim ([0.5 2.5]);
    xlim ([0.2 2.8]);
...
% Group averages
    a2 = subplot(3,2,2);
    bar(1, mean(groupEyeData.groupNumFix_conj), 0.8, 'FaceColor', C_color, 'EdgeColor', C_color); hold on
    bar(2, mean(groupEyeData.groupNumFix_summ), 0.8, 'FaceColor', E_color, 'EdgeColor', E_color); hold on
...
% Single Subjects
    ...
    scatter(repmat(1,1,size(groupEyeData,1)), groupEyeData.groupDurFix_conj, 70, 'MarkerEdgeColor', C_color, 'MarkerFaceColor', C_color, 'MarkerFaceAlpha', 0.5);
    scatter(repmat(2,1,size(groupEyeData,1)), groupEyeData.groupDurFix_summ, 70,'MarkerEdgeColor', E_color, 'MarkerFaceColor', E_color, 'MarkerFaceAlpha', 0.5);
    hold off
    %title ('All participants');
    xlim ([0.5 2.5]);
    xlim ([0.2 2.8]);
...
% Group averages
    a6 = subplot(3,2,6);
    bar(1, mean(groupEyeData.groupDurFix_conj), 0.8, 'FaceColor', C_color, 'EdgeColor', C_color); hold on
    bar(2, mean(groupEyeData.groupDurFix_summ), 0.8, 'FaceColor', E_color, 'EdgeColor', E_color); hold on
...
%% code for stats
    ...
    [h,p,ci,stats] = ttest(groupEyeData.groupDurFix_conj, groupEyeData.groupDurFix_summ)
    if p < 0.001
        sig = '***';
    elseif p < 0.01
        sig = '**';
...
%         'LineStyle', 'none', 'FontSize', 16);
 ...
 % Sve high-res figure
 print(gcf1, '-dtiff', 'eyeTracking_variables_BehavSamepleN34.tiff', '-r600');
